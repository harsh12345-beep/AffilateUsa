  ...
  return (
        ...
        <div className="fade-in flex flex-col sm:flex-row bg-gray-100 justify-between items-center sm:px-8 px-4 py-6">
          <div className="w-full sm:w-1/2">
            ...
            <div className="fade-in px-4 sm:px-6 py-4 sm:py-8">
          ...
          <div className="w-full sm:w-1/2 flex justify-center sm:justify-end mt-6 sm:mt-0">
            <img className="fade-in w-3/4 sm:w-2/3 rounded-lg" src={imagee} alt="Representation of collaboration" />
          </div>
        </div>

        <div className="fade-in bg-slate-300 pt-8 ">
        ...
        <div className="bg-[#EFEAE3] pt-20 fade-in">
